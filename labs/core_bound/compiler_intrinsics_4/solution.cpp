...
std::vector<short> mandelbrot(int image_width, int image_height) {
  ...
  std::array<int, kUnrollSz> px;
  std::array<int, kUnrollSz> py;
  ...
  alignas(sizeof(Vec)) std::array<std::array<double, kVecSize>, kUnrollSz> c_x_arr;
  alignas(sizeof(Vec)) std::array<std::array<double, kVecSize>, kUnrollSz> c_y_arr;
  ...
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> c_x;
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> c_y;
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> z_x;
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> z_y;
  ...
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> z_xx;
  alignas(sizeof(Vec)) std::array<Vec, kUnrollSz> z_yy;
