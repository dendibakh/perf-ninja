...
constexpr int high_iterations = 1000;
constexpr int iterations = 50;

BENCHMARK_CAPTURE(bench1, _63,  63)->Unit(benchmark::kMicrosecond)->Iterations(high_iterations);
#ifndef ON_MACOS
BENCHMARK_CAPTURE(bench1, _64,  64)->Unit(benchmark::kMicrosecond)->Iterations(high_iterations);
#endif
BENCHMARK_CAPTURE(bench1, _65,  65)->Unit(benchmark::kMicrosecond)->Iterations(high_iterations);
...
#ifndef ON_MACOS
BENCHMARK_CAPTURE(bench1, _128, 128)->Unit(benchmark::kMicrosecond)->Iterations(high_iterations);
#endif
...
#ifndef ON_MACOS
BENCHMARK_CAPTURE(bench1, _256, 256)->Unit(benchmark::kMicrosecond)->Iterations(high_iterations);
#endif
//BENCHMARK_CAPTURE(bench1, _257, 257)->Unit(benchmark::kMicrosecond);
BENCHMARK_CAPTURE(bench1, _511, 511)->Unit(benchmark::kMicrosecond)->Iterations(iterations);
#ifndef ON_MACOS
BENCHMARK_CAPTURE(bench1, _512, 512)->Unit(benchmark::kMicrosecond)->Iterations(iterations);
#endif
BENCHMARK_CAPTURE(bench1, _513, 513)->Unit(benchmark::kMicrosecond)->Iterations(iterations);
//BENCHMARK_CAPTURE(bench1, _1023, 1023)->Unit(benchmark::kMicrosecond);
#ifndef ON_MACOS
BENCHMARK_CAPTURE(bench1, _1024, 1024)->Unit(benchmark::kMicrosecond)->Iterations(iterations);
#endif
